...
public class MobileDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String strImage = getIntent().getExtras().getString("mobil_image");
        String strTitle = getIntent().getExtras().getString("mobil_title");
        String strDesc = getIntent().getExtras().getString("mobil_desc");
